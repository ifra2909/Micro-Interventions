...
export const EMOTION_FAMILIES: EmotionFamily[] = [
  {
    id: "anxious", label: "anxious / afraid", color: "#B8C9D9",
  ...
  {
    id: "sad", label: "sad / heavy", color: "#B8C9D9",
  ...
  {
    id: "angry", label: "angry / irritated", color: "#E8C4B8",
  ...
  {
    id: "shame", label: "ashamed / embarrassed", color: "#D9B8B8",
  ...
  {
    id: "lonely", label: "lonely / unseen", color: "#C8B8D9",
  ...
  {
    id: "overwhelm", label: "overwhelmed / flooded", color: "#B8D4C8",
  ...
  {
    id: "numb", label: "numb / flat", color: "#C4B8D4",
  ...
  {
    id: "tired", label: "drained / burned out", color: "#E8D4B8",
